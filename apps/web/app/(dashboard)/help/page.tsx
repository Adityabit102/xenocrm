...
const FAQS = [
    ...
    },
    {
        ...
        a: "XenoCRM supports WhatsApp, SMS, Email, and RCS. The channel service simulates real delivery lifecycle events including delivered, opened, read, clicked, and order attributed."
    },
    {
        ...
        <div style={{ maxWidth: 780, margin: "0 auto", padding: "32px 0" }}>
            <div style={{ marginBottom: 32 }}>
                ...
                <p style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.82rem", color: "#7B82A0", marginTop: 6 }}>
                    Guides, FAQs, and resources for XenoCRM.
                </p>
            </div>

            {/* Quick Resources */}
            <div style={{ marginBottom: 24 }}>
                <div style={{ fontFamily: "Syne,sans-serif", fontWeight: 700, fontSize: "0.85rem", color: "#7B82A0", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 14 }}>
                    Resources
                </div>
                    ...
                    {RESOURCES.map(({ icon: Icon, title, description, href }) => (
                        <a key={title} href={href} style={{ textDecoration: "none" }}>
                            <div
                                ...
                                onMouseEnter={e => ((e.currentTarget as HTMLDivElement).style.borderColor = "rgba(91,95,239,0.4)")}
                            ...
                            >
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                                        ...
                                        <ExternalLink style={{ width: 11, height: 11, color: "#464555" }} />
                                    </div>
                                    <div style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.75rem", color: "#7B82A0", marginTop: 3 }}>
                                        {description}
                                    </div>
                                </div>
                            </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {FAQS.map(({ q, a }, idx) => (
                        <div key={idx} style={{
                            ...
                            >
                                <span style={{ fontFamily: "DM Sans,sans-serif", fontWeight: 600, fontSize: "0.82rem", color: "#EDF0FF" }}>
                                    {q}
                                </span>
                                <ChevronDown style={{
                                    width: 15, height: 15, color: "#7B82A0", flexShrink: 0,
            ...
            {}
            <div style={{
                marginTop: 24, background: "rgba(91,95,239,0.06)",
                border: "1px solid rgba(91,95,239,0.2)", borderRadius: 16,
                ...
                <div>
                    ...
                    <div style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.78rem", color: "#7B82A0", marginTop: 4 }}>
                        Reach out to the XenoCRM team for support.
                    </div>
                </div>
                <a href="mailto:support@xenocrm.com" style={{ textDecoration: "none" }}>
                    <button style={{
                        padding: "10px 20px", borderRadius: 10,
                        background: "rgba(91,95,239,0.15)", border: "1px solid rgba(91,95,239,0.3)",
                        fontFamily: "DM Sans,sans-serif", fontSize: "0.8rem", color: "#c0c1ff",
