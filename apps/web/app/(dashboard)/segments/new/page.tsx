  ...
  if (id && isLoadingSegment) {
    return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 80, gap: 12 }}>
        ...
        <p style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.82rem", color: "#7B82A0" }}>Loading segment details...</p>
    ...
    <div style={{ fontFamily: "DM Sans,sans-serif", color: "#EDF0FF", maxWidth: 1400 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 400px", gap: 20, alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {}
          <div style={{ background: "#13151F", border: "1px solid #1A2035", borderRadius: 12, padding: "22px 24px" }}>

            {}
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap", paddingBottom: 16, marginBottom: 20, borderBottom: "1px solid #1A2035" }}>
              <div>
                <div style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#464555", marginBottom: 3 }}>
                  Cohort Builder Mode
                </div>
                <div style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.78rem", color: "#7B82A0" }}>
                  Select builder style for defining rules.
                </div>
              </div>
              <div style={{ display: "flex", background: "rgba(255,255,255,0.03)", border: "1px solid #1A2035", borderRadius: 10, padding: 4, gap: 4 }}>
                {(["AI", "manual"] as const).map(m => (
                  <button key={m} type="button" onClick={() => setMode(m)}
                    style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 14px", borderRadius: 8, border: mode === m ? "1px solid #252D48" : "1px solid transparent", background: mode === m ? "#13151F" : "transparent", color: mode === m ? (m === "AI" ? "#d7baff" : "#c0c1ff") : "#7B82A0", fontFamily: "DM Sans,sans-serif", fontSize: "0.78rem", fontWeight: 700, cursor: "pointer", transition: "all 0.15s" }}>
            ...
            {mode === "AI" ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                {rules.conditions.length > 0 && (
                  <div style={{ border: "1px solid rgba(215,186,255,0.2)", background: "rgba(215,186,255,0.04)", borderRadius: 10, padding: "14px 16px" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12, paddingBottom: 10, borderBottom: "1px solid rgba(215,186,255,0.15)" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                        <Sparkles style={{ width: 12, height: 12, color: "#d7baff" }} />
                        <span style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#d7baff" }}>
                          AI-Generated Visual Rules
                        </span>
                      </div>
                      <span style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.65rem", color: "#7B82A0" }}>Tweak visually below</span>
                    </div>
          ...
          {/* Metadata card */}
          <div style={{ background: "#13151F", border: "1px solid #1A2035", borderRadius: 12, padding: "22px 24px" }}>
            <div style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#464555", marginBottom: 16, paddingBottom: 12, borderBottom: "1px solid #1A2035" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {}
              <div>
                <label style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.78rem", fontWeight: 600, color: "#c6c5d7", display: "block", marginBottom: 6 }}>
                  Segment Name <span style={{ color: "#FF4D6A" }}>*</span>
                </label>
                <input
                  type="text"
            ...
            {}
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 20, paddingTop: 16, borderTop: "1px solid #1A2035" }}>
              <button onClick={() => router.push("/segments")}
                style={{ display: "flex", alignItems: "center", gap: 6, padding: "9px 18px", background: "rgba(255,255,255,0.04)", border: "1px solid #1A2035", borderRadius: 8, color: "#EDF0FF", fontFamily: "DM Sans,sans-serif", fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", transition: "all 0.15s" }}>
                <X style={{ width: 14, height: 14 }} /> Cancel
              </button>
              <button onClick={handleSave} disabled={isSaveDisabled}
                style={{ display: "flex", alignItems: "center", gap: 6, padding: "9px 20px", background: isSaveDisabled ? "#1A2035" : "#5b5fef", border: "none", borderRadius: 8, color: isSaveDisabled ? "#464555" : "#fff", fontFamily: "Syne,sans-serif", fontSize: "0.85rem", fontWeight: 700, cursor: isSaveDisabled ? "not-allowed" : "pointer", transition: "all 0.15s", opacity: isSaving ? 0.7 : 1 }}>
                {isSaving
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, position: "sticky", top: 80 }}>
          ...
          {/* AI insight callout */}
          {insight && (
            <div style={{ background: "rgba(215,186,255,0.06)", border: "1px solid rgba(215,186,255,0.2)", borderRadius: 12, padding: "16px 18px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
                <Sparkles style={{ width: 13, height: 13, color: "#d7baff" }} />
                <span style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#d7baff" }}>
                  AI Builder Summary
                </span>
              </div>
              <p style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.78rem", color: "#7B82A0", lineHeight: 1.6, margin: 0 }}>
                {insight}
              </p>
            </div>
          )}
  ...
  return (
    <React.Suspense
      fallback={
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 80, gap: 12 }}>
          <Loader2 style={{ width: 28, height: 28, color: "#c0c1ff", animation: "spin 1s linear infinite" }} />
          <p style={{ fontFamily: "DM Sans,sans-serif", fontSize: "0.82rem", color: "#7B82A0" }}>Initializing Segment Builder...</p>
          <style>{`@keyframes spin{to{transform:rotate(360deg)}}`}</style>
        </div>
      }
    >
